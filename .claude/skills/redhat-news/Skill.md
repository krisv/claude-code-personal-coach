...
python .claude/skills/redhat-news/news_monitor.py --post-comment ARTICLE_ID "This costs $1000"
...
- **Single quotes (`'`)**: Prevents ALL shell expansion - what you type is what Python receives
- **Double quotes (`"`)**: Allows variable expansion (`$VAR`), command substitution, etc.
- **Backslash (`\$`)**: Escapes individual special characters in double quotes

**Best practice:** For comment text with dollar signs, percentages, or other special characters, use single quotes.
